    ...
    <el-main id="member" style='padding-bottom:100px;'>
        <div class="memberNav" @click.native="closeInfo">
            <el-row class="navChild">
                ...
                <el-col :span='9'>
                    <div class="grid-content search" v-show="isShow">
                        <el-input placeholder="请输入模板名" suffix-icon="el-icon-search" v-model="valuesearch" @keyup.native.13="show($event)">
                        </el-input>
        ...
        <div class="memberMain">
            <div class='boderBox'>
               <Datatable v-show="dataTableShow"></Datatable>
               <bindingEntry v-show="bindingEntryShow"></bindingEntry>
            </div>
